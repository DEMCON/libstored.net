...
/// </code>
/// </summary>
public class ExampleStore : Store, INotifyPropertyChanged
{
    private static readonly byte[] InitialBuffer = [0x01, 0, 0, 0];
    ...
    {
        // Notify property changed for the specific variable that changed
        ...
        {
            0 => nameof(ExampleStore.Number),
            4 => nameof(ExampleStore.Fraction),
            12 => nameof(ExampleStore.Text),
            27 => nameof(ExampleStore.FourInts0),
            28 => nameof(ExampleStore.FourInts1),
            29 => nameof(ExampleStore.FourInts2),
            30 => nameof(ExampleStore.FourInts3),
